...
G4HodoscopeDetectorConstruction::CreateWorld()
{
	...
	double fWorldSizeY = 20 * CLHEP::m;
	double fWorldSizeZ = 20 * CLHEP::m;
...
//###################--------OBJETIVO CON INTERFASE------------#################################
	...
	double Dist = 1000 * CLHEP::cm;// distancia horizontal a la cual està el centro del cilindro
        double CoorYc = -850 * CLHEP::cm;// coordenada vertical del centro de la base del cilindro
        double HeightCyl01 = 400 * CLHEP::cm;
        double HeightCyl02 = 50 * CLHEP::cm;
        double HeightCyl03 = 400 * CLHEP::cm;
        double HeightCyl04 = 30 * CLHEP::cm;
        double HeightCyl05 = 400 * CLHEP::cm;
        double HeightCyl06 = 20 * CLHEP::cm;
        double HeightCyl07 = 400 * CLHEP::cm;
